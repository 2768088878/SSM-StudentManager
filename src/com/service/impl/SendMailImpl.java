...
public class SendMailImpl {
	// 发件人的邮箱账号如：xxx@163.com
		public static String sendEmailAccount = "2768088878@qq.com";
		// 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
		public static String sendEmailPassword = "xaodqtfcrptgdcjg";
		...
		public MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
			...
			// 设置发件人姓名和编码格式
			message.setFrom(new InternetAddress(sendMail, "学生管理系统", "UTF-8"));
